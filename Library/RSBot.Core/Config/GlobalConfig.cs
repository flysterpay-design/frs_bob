...
public static class GlobalConfig
{
    ...
    public static bool IsPluginEnabled(string pluginInternalName, bool defaultValue = true)
    {
        return Get($"RSBot.Plugins.{pluginInternalName}.Enabled", defaultValue);
    }

    public static void SetPluginEnabled(string pluginInternalName, bool enabled)
    {
        Set($"RSBot.Plugins.{pluginInternalName}.Enabled", enabled);
        Save();
    }
}
