...
internal static class LureConfig
{
    ...
    public static bool StopIfTotalMonsters
    {
        get => PlayerConfig.Get("RSBot.Lure.StopIfTotalMonsters", false);
        set => PlayerConfig.Set("RSBot.Lure.StopIfTotalMonsters", value);
    }

    public static int TotalMonstersCount
    {
        get => PlayerConfig.Get("RSBot.Lure.TotalMonstersCount", 10);
        set => PlayerConfig.Set("RSBot.Lure.TotalMonstersCount", value);
    }
}
